...
<head>
    ...
    <title>Update Category | E - Books</title>
            ...
            <div class="pt-24 p-6">
                <div class="container mx-auto">
                    <div class="backdrop-blur-2xl bg-slate-800/30 rounded-2xl shadow-2xl hover:shadow-emerald-500/20 transition-all duration-500 p-8 max-w-md mx-auto scroll-animate">
                        <h1 class="text-2xl font-bold text-white mb-6 text-center">Update Category</h1>
                        <form method="POST" class="space-y-4">
                            <div>
                                <label class="block text-sm font-medium text-slate-300 mb-1">Category Name</label>
                                <input type="text" name="CategoryName" required class="form-input w-full px-4 py-2 rounded-button text-white" value="<?php echo htmlspecialchars($category['CategoryName']); ?>">
                            </div>
                            <div class="text-center">
                                <button type="submit" class="submit-button text-white px-6 py-2 rounded-button font-medium hover:bg-emerald-600">Save Changes</button>
                            </div>
                        </form>
                        <div class="mt-4 text-center">
                            <a href="admin.category.php" class="text-emerald-400 hover:text-emerald-500 text-sm font-medium">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
